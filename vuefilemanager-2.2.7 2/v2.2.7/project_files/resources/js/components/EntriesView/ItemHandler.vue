<template>
    <div class="item-handler">
        <ItemList
            ...
            :class="[
                'hover:bg-apple-gray-100 dark:hover:bg-2x-dark-foreground transition-colors duration-200',
                { 'ring-2 ring-apple-blue': area }
            ]"
        />
        ...
        <ItemGrid
            ...
            @dragover.prevent.native="dragEnter"
            :class="[
                'p-4 rounded-apple bg-white dark:bg-dark-foreground shadow-apple-button hover:shadow-apple transition-all duration-200',
                { 'ring-2 ring-apple-blue': area }
            ]"
        />
    </div>
...
.file-wrapper {
    ...
    .actions {
        @apply text-right w-12;

        .show-actions {
            @apply cursor-pointer py-3 pl-1.5;

            .icon-action {
                @apply mt-2 text-sm text-apple-gray-500 hover:text-apple-gray-600 transition-colors duration-200;
            }
        }
    }
...
.dark {
    .file-wrapper {
        ...
        .actions {
            .show-actions {
                .icon-action {
                    @apply text-apple-gray-400 hover:text-apple-gray-300;
                }
            }
        }
    }
